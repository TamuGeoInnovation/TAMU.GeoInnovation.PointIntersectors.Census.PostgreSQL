...
namespace TAMU.GeoInnovation.PointIntersectors.Census.PostgreSQL.Census2010
{
    ...
    [Serializable]
    public class PostgreSQLCensus2010PointIntersector : AbstractCensus2010PointIntersector
    {
        ...
        public PostgreSQLCensus2010PointIntersector()
            : base()
        { }

        public PostgreSQLCensus2010PointIntersector(double version, IQueryManager blockFilesQueryManager, IQueryManager stateFilesQueryManager, IQueryManager countryFilesQueryManager)
